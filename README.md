...
## Контент-воркфлоу (сертифікати/дипломи на /kvalifikatsiya/)

Кожен сертифікат — окремий файл у `src/certificates/`. Дивіться готовий
приклад `src/certificates/PRYKLAD-shablon.md` — скопіюйте його, перейменуйте
файл (наприклад `sertyfikat-poligraf-2013.md`) і заповніть своїми даними:
...
`kvalifikatsiya.njk` не потрібно.
