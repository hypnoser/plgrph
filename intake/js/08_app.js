...
var HELP_STEPS = [
  ...
  { h:"6. Завершіть і перегляньте звіт", p:"Кнопка «Завершити анкетування» відкриває вибір: зашифрувати файл сесії паролем чи лишити відкритим. Вікно респондента закриється автоматично. Після цього одразу показується звіт." },
  { h:"7. Читайте звіт", p:"Зверху — короткий висновок, на що звернути увагу. Нижче — карта питань кольором за рівнем значущості: чим темніший колір, тим важливіше. Клік по питанню відкриває розбір патернів, які сформували цю оцінку." },
  { h:"8. Налаштування", p:"Кнопка з шестернею в шапці веде в розділ «Налаштування» — робоча тека, файл для запису, друк, видалення даних. Якщо задано PIN, розділ запитає його при вході." }
];
function renderHelp(){
